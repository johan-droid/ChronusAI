    ...
    <div className="flex flex-col min-h-screen bg-[#050510] relative overflow-x-hidden">
      ...
      <main className="flex-1 relative z-10 p-4 sm:p-6 mb-20 lg:mb-0 w-full max-w-full overflow-hidden">
        <div className="max-w-2xl mx-auto w-full space-y-6">
          ...
          {/* Account Info */}
          <section className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-4 sm:p-6 fade-in-up w-full max-w-full overflow-hidden" style={{ animationDelay: '0.05s' }}>
          ...
          {/* Connected Services */}
          <section className="bg-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-4 sm:p-6 fade-in-up w-full max-w-full overflow-hidden" style={{ animationDelay: '0.1s' }}>
            <h2 className="text-lg font-semibold text-white mb-4">Connected Services</h2>
            <div className="space-y-4">
              {/* Zoom Integration */}
              <div className="bg-white/5 rounded-xl border border-white/5 p-4 w-full max-w-full overflow-hidden">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2 sm:px-6 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-lg transition-colors min-h-[44px] touch-manipulation"
                  >
                    Connect
                  </button>
                </div>
              ...
              <div className="bg-white/5 rounded-xl border border-white/5 p-4 w-full max-w-full overflow-hidden">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
                  ...
                  <button
                    onClick={async () => {
                      try {
                        const { auth_url } = await apiClient.getAuthUrl('google');
                        window.location.href = auth_url;
                      } catch (error) {
          ...
          {/* Danger Zone */}
          <section className="bg-red-500/5 backdrop-blur-xl border border-red-500/20 rounded-2xl p-4 sm:p-6 fade-in-up w-full max-w-full overflow-hidden" style={{ animationDelay: '0.15s' }}>
            ...
            {!showDeleteConfirm ? (
              <button
                ...
                className="w-full sm:w-auto px-4 py-3 bg-red-500/10 hover:bg-red-500/20 border border-red-500/30 text-red-400 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 font-medium min-h-[44px] touch-manipulation"
              >
                <Trash2 className="h-4 w-4" />
                Delete Account
              </button>
            ) : showDeleteSuccess ? (
              <div className="bg-green-500/10 border border-green-500/30 rounded-xl p-4 text-center w-full max-w-full overflow-hidden">
              ...
              <div className="space-y-4 animate-fade-in w-full max-w-full overflow-hidden">
                <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-4 w-full max-w-full overflow-hidden">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <ul className="text-xs text-slate-400 space-y-1 mb-3 list-disc list-inside w-full max-w-full overflow-hidden">
                      ...
                      <div className="mb-3">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-black/30 border border-red-500/30 rounded-lg text-white text-sm placeholder:text-slate-600 focus:outline-none focus:border-red-500/50 text-base"
                          autoFocus
                        />
                      </div>
                ...
                <div className="flex gap-3 w-full max-w-full overflow-hidden">
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-slate-800/50 hover:bg-slate-800 border border-white/10 text-white rounded-xl transition-all duration-200 disabled:opacity-50 flex items-center justify-center gap-2 min-h-[44px] touch-manipulation"
                  >
                    <X className="h-4 w-4" />
                    Cancel
                  </button>
                  <button
                    ...
                    className="flex-1 px-4 py-2.5 bg-red-500 hover:bg-red-600 disabled:bg-red-500/50 text-white rounded-xl transition-all duration-200 flex items-center justify-center gap-2 font-medium disabled:opacity-50 min-h-[44px] touch-manipulation"
                  >
                    {deleteLoading ? (
                      <>
